...
return [
    ...
    'contacts' => [
        'persons' => [
            'index' => [
                ...
                'create-success'         => 'Cliente creada con éxito.',
                'update-success'         => 'Cliente actualizada con éxito.',
                'delete-success'         => 'Cliente eliminada con éxito.',
        ...
        'organizations' => [
            'index' => [
                ...
                'datagrid'       => [
                    ...
                    'id'            => 'ID',
                    'name'          => 'Nombre',
                    'persons-count' => 'Número de Clientes',
                ],
            ],
            'create' => [
    ...
    'settings' => [
        ...
        'workflows' => [
            ...
            'helpers' => [
                ...
                'update-person'              => 'Actualizar Cliente',
                'send-email-to-person'       => 'Enviar correo al cliente',
    ...
    'leads' => [
        ...
        'index' => [
            ...
            'datagrid'   => [
                'id'             => 'ID',
                'sales-person'   => 'Cliente de Ventas',
                'subject'        => 'Asunto',
                'source'         => 'Fuente',
        ...
        'create' => [
            ...
            'details-info'   => 'Registra los datos principales del pedido del cliente',
            'contact-person' => 'Cliente de contacto',
            'contact-info'   => 'Información sobre el Cliente',
            'products'       => 'Productos',
    ...
    'dashboard' => [
        'index' => [
            ...
            'over-all' => [
                ...
                'total-leads'           => 'Total de Clientes',
                'average-leads-per-day' => 'Clientes Promedio por Día',
            ...
            'open-leads-by-states' => [
                'title'       => 'Clientes Abiertos por Etapas',
                'empty-title' => 'No Hay Datos Disponibles',
                'empty-info'  => 'No hay datos disponibles para el intervalo seleccionado',
            ],
        ],
