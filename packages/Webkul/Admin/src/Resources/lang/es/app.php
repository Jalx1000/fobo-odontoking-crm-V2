...
return [
        ...
        'layouts' => [
            ...
            'header' => [
                'mega-search' => [
                    ...
                    'explore-all-matching-products' => 'Explorar todos los servicios que coinciden con ":query" (:count)',
    ...
    'quotes' => [
        ...
        'create' => [
            ...
            'search-products'   => 'Buscar Servicios',
    ...
    'contacts' => [
        'persons' => [
            'index' => [
                'title'                  => 'Pacientes',
                'create-btn'             => 'Crear Paciente',
                'create-success'         => 'Paciente creada con éxito.',
                'update-success'         => 'Paciente actualizada con éxito.',
                'delete-success'         => 'Paciente eliminada con éxito.',
            ...
            'view' => [
                'title'              => ':name',
                'about-person'       => 'Sobre la Paciente',
    ...
    'settings' => [
        ...
        'workflows' => [
            ...
            'helpers' => [
                ...
                'update-person'              => 'Actualizar Paciente',
                'send-email-to-person'       => 'Enviar correo a la Paciente',
    ...
    'mail' => [
        ...
        'view'                => [
            ...
            'contact-person'             => 'Nombre de paciente',
            'product'                    => 'Servicio',
            'tags'                       => [
                'create-success'  => 'Etiqueta creada con éxito.',
                'destroy-success' => 'Etiqueta eliminada con éxito.',
    ...
    'leads' => [
        ...
        'index' => [
            ...
            'datagrid'   => [
                'id'             => 'ID',
                'sales-person'   => 'Recepcionista',
                'subject'        => 'Asunto',
                'source'         => 'Fuente',
                'lead-value'     => 'Precio de consulta',
                'lead-type'      => 'Tipo de paciente',
        ...
        'create' => [
            ...
            'details-info'   => 'Registra los datos principales de la cita del paciente',
        ...
        'view' => [
            ...
            'products' => [
                ...
                'empty-info'   => 'No se Encontraron Servicios para este Lead',
    ...
    'dashboard' => [
        'index' => [
            ...
            'open-leads-by-states' => [
                'title'       => 'Pacientes Abiertos por Etapas',
                'empty-title' => 'No Hay Datos Disponibles',
                'empty-info'  => 'No hay datos disponibles para el intervalo seleccionado',
            ],
        ],
    ...
    'layouts' => [
        ...
        'lead'                 => 'Paciente',
        'lead-info'            => 'Administra todas las configuraciones relacionadas con los pacientes en el CRM',
        'pipelines'            => 'Pipelines',
