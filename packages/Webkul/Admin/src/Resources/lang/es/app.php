...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Desarrollado por <span style="color: #BA2831;"><a href="https://sofopolis.com/ai/" target="_blank">Sofopolis</a></span>',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Búsqueda Mega',
    ...
    'contacts' => [
        'persons' => [
            'index' => [
                'title'                  => 'Prospectos',
                'create-btn'             => 'Crear Prospecto',
                'create-success'         => 'Prospecto creada con éxito.',
                'update-success'         => 'Prospecto actualizada con éxito.',
                'delete-success'         => 'Prospecto eliminada con éxito.',
                'all-delete-success'     => 'Todas los clientes seleccionadas fueron eliminadas exitosamente.',
                'partial-delete-warning' => 'Algunos clientes fueron eliminadas con éxito. Otras no se pudieron eliminar porque están vinculadas a pedidos.',
                'none-delete-warning'    => 'Ninguno de las clientes seleccionadas pudo ser eliminada porque están vinculadas a pedidos.',
                'no-selection'           => 'No se seleccionaron clientes para eliminar.',
            ...
            'view' => [
                'title'              => ':name',
                'about-person'       => 'Sobre la Prospecto',
        ...
        'organizations' => [
            'index' => [
                ...
                'datagrid'       => [
                    ...
                    'id'            => 'ID',
                    'name'          => 'Nombre',
                    'persons-count' => 'Número de Prospectos',
                ],
            ],
            'create' => [
    ...
    'settings' => [
        ...
        'sources' => [
            'index' => [
                ...
                'delete-failed-associated-leads' => 'No se puede eliminar la fuente porque está asociada a pedidos existentes. Por favor, desvincúlelos o actualícelos antes de eliminar.',
                'datagrid'                       => [
                    'delete' => 'Eliminar',
                    'edit'   => 'Editar',
                    'id'     => 'ID',
        ...
        'workflows' => [
            ...
            'helpers' => [
                ...
                'update-person'              => 'Actualizar Prospecto',
                'send-email-to-person'       => 'Enviar correo al prospecto',
    ...
    'activities' => [
        ...
        'created'              => 'Creado',
        'duration-overlapping' => 'Los participantes tienen otra consulta en este momento. ¿Deseas continuar?',
    ...
    'mail' => [
        ...
        'view'                => [
            ...
            'rotten-days'                => 'El pedido está en estado crítico por :days días',
            'search-an-existing-lead'    => 'Buscar un pedido existente',
    ...
    'leads' => [
        ...
        'index' => [
            ...
            'datagrid'   => [
                'id'             => 'ID',
                'sales-person'   => 'Prospecto de Ventas',
                'subject'        => 'Asunto',
                'source'         => 'Fuente',
                'lead-value'     => 'Valor del Lead',
                'lead-type'      => 'Tipo de pedido',
            ...
            'kanban' => [
                'rotten-days'            => 'El pedido está estancado desde hace :days días',
                'empty-list'             => 'Tu lista de leads está vacía',
                'empty-list-description' => 'Crea un pedido para organizar tus objetivos.',
                'create-lead-btn'        => 'Crear Pedido',
                'columns'                => [
                    'contact-person'      => 'Contacto del Prospecto',
                    'id'                  => 'ID',
                ...
                'stages' => [
                    ...
                    'won-value' => 'Monto ganado',
                    'closed-at' => 'Fecha de cierre',
                    'save-btn' => 'Guardar',
            ...
            'upload' => [
                'create-lead'   => 'Crear Pedido Usando IA',
        ...
        'create' => [
            'title'          => 'Crear Pedido',
            'save-btn'       => 'Guardar',
            'details'        => 'Información del pedido',
            'details-info'   => 'Registra los datos principales del pedido del prospecto',
            'contact-person' => 'Prospecto de contacto',
            'contact-info'   => 'Información sobre el Prospecto',
            'products'       => 'Productos',
    ...
    'dashboard' => [
        'index' => [
            ...
            'revenue' => [
                ...
                'won-revenue'  => 'Ventas (Bs.)',
            ],
            'over-all' => [
                'average-lead-value'    => 'Valor Promedio de Pedido',
            ...
            'top-persons' => [
                'title'       => 'Prospectos Más Destacadas',
                'empty-title' => 'No Se Encontraron Prospectos',
                'empty-info'  => 'No hay clientes disponibles para el intervalo seleccionado',
            ],

            'vendedores' => [
                'title'                   => 'Vendedores',
                'empty-title'             => 'No Se Encontraron Vendedores',
                'empty-info'              => 'No hay datos de vendedores para el intervalo seleccionado',
                'no-response'             => 'Sin respuesta',
            ],
            'open-leads-by-states' => [
                'title'       => 'Prospectos Abiertos por Etapas',
                'empty-title' => 'No Hay Datos Disponibles',
                'empty-info'  => 'No hay datos disponibles para el intervalo seleccionado',
            ],
        ],
    ...
    'layouts' => [
        ...
        'lead'                 => 'Pedido',
        'lead-info'            => 'Administra todas las configuraciones relacionadas con los clientes en el CRM',
        'pipelines'            => 'Pipelines',
        ...
        'data_transfer_info'   => 'Gestionar la configuración relacionada con la transferencia de datos de clientes, productos y pedidos en el CRM',
    ],
    'user' => [
        'account' => [
            'name'                 => 'Nombre',
    ...
    'emails' => [
        'common' => [
            ...
            'user'   => [
                ...
                'forget-password' => [
                    'subject'        => 'Restablecimiento de Contraseña del Prospecto',
                    'dear'           => 'Estimado/a :username',
                    'reset-password' => 'Restablecer Contraseña',
                    'info'           => 'Estás recibiendo este correo porque recibimos una solicitud de restablecimiento de contraseña para tu cuenta',
                    'final-summary'  => 'Si no solipedidoste el restablecimiento de contraseña, no se requiere ninguna acción adicional',
                    'thanks'         => '¡Gracias!',
                ],
            ],
        ],
