{!! view_render_event('admin.dashboard.index.ventas_por_sucursal.before') !!}

<v-dashboard-ventas-por-sucursal>
    <x-admin::shimmer.dashboard.index.top-selling-products />
</v-dashboard-ventas-por-sucursal>

{!! view_render_event('admin.dashboard.index.ventas_por_sucursal.after') !!}

@pushOnce('scripts')
    <script type="text/x-template" id="v-dashboard-ventas-por-sucursal-template">
    ...
    <script type="module">
        app.component('v-dashboard-ventas-por-sucursal', {
            template: '#v-dashboard-ventas-por-sucursal-template',
            ...
            methods: {
                getStats(filters) {
                    ...
                    filters.type = 'ventas-por-sucursal';
