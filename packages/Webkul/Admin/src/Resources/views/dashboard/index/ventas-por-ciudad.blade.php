{!! view_render_event('admin.dashboard.index.ventas_por_ciudad.before') !!}

<v-dashboard-ventas-por-ciudad>
    <x-admin::shimmer.dashboard.index.total-leads />
</v-dashboard-ventas-por-ciudad>

{!! view_render_event('admin.dashboard.index.ventas_por_ciudad.after') !!}

@pushOnce('scripts')
    <script type="text/x-template" id="v-dashboard-ventas-por-ciudad-template">
        ...
        <template v-else>
            <div class="grid gap-4 rounded-lg border border-gray-200 bg-white px-4 py-2 dark:border-gray-800 dark:bg-gray-900">
                <div class="flex flex-col justify-between gap-1">
                    <p class="text-base font-semibold dark:text-gray-300">Ventas por Pipeline</p>
                </div>
    ...
    <script type="module">
        app.component('v-dashboard-ventas-por-ciudad', {
            template: '#v-dashboard-ventas-por-ciudad-template',
            ...
            methods: {
                ...
                getStats(filters) {
                    ...
                    filters.type = 'ventas-por-ciudad';
