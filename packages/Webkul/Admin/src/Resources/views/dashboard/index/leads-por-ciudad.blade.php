{!! view_render_event('admin.dashboard.index.leads_por_ciudad.before') !!}

<v-dashboard-leads-por-ciudad>
    <x-admin::shimmer.dashboard.index.total-leads />
</v-dashboard-leads-por-ciudad>

{!! view_render_event('admin.dashboard.index.leads_por_ciudad.after') !!}

@pushOnce('scripts')
    <script type="text/x-template" id="v-dashboard-leads-por-ciudad-template">
        ...
        <template v-else>
            <div class="grid gap-4 rounded-lg border border-gray-200 bg-white px-4 py-2 dark:border-gray-800 dark:bg-gray-900">
                <div class="flex flex-col justify-between gap-1">
                    <p class="text-base font-semibold dark:text-gray-300">Leads por Pipeline</p>
                </div>
    ...
    <script type="module">
        app.component('v-dashboard-leads-por-ciudad', {
            template: '#v-dashboard-leads-por-ciudad-template',
