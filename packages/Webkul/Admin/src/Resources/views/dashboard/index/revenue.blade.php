                ...
                <div class="flex gap-4 max-md:flex-wrap">
                        ...
                        <div class="flex flex-col gap-2 rounded-lg border border-gray-200 px-4 py-5 dark:border-gray-800 max-sm:w-full">
                            ...
                            <div class="flex gap-2">
                                <p class="text-xl font-bold text-green-600">
                                    @{{ $admin.formatPrice(Math.round(report.statistics.total_won_revenue.current)) }}
                                </p>
                                ...
                                <div class="flex items-center gap-0.5">
                                    ...
                                    >
                                        @{{ Math.round(Math.abs(report.statistics.total_won_revenue.progress)) }}%
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 rounded-lg border border-gray-200 px-4 py-5 dark:border-gray-800 max-sm:w-full">
                            ...
                            <div class="flex gap-2">
                                <p class="text-xl font-bold text-blue-600">
                                    @{{ report.statistics.ventas_count.current }}
                                </p>

                                <div class="flex items-center gap-0.5">
                                    <span
                                        class="text-base !font-semibold text-green-500"
                                        :class="[report.statistics.ventas_count.progress < 0 ? 'icon-stats-down text-red-500 dark:!text-red-500' : 'icon-stats-up text-green-500 dark:!text-green-500']"
                                    ></span>

                                    <p
                                        class="text-xs font-semibold text-green-500"
                                        :class="[report.statistics.ventas_count.progress < 0 ?  'text-red-500' : 'text-green-500']"
                                    >
                                        @{{ Math.abs(report.statistics.ventas_count.progress.toFixed(2)) }}%
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex w-full max-w-full flex-col gap-4">
                        ...
                        <div class="flex justify-center gap-5">
                            ...
                            <div class="flex items-center gap-2">
                                <span class="h-3.5 w-3.5 rounded-sm bg-blue-600 opacity-80"></span>
                    ...
                    this.chart = new Chart(document.getElementById(this.$.uid + '_chart'), {
                        ...
                        data: {
                            ...
                            datasets: [{
                                axis: 'y',
                                data: [
                                    Math.round(this.report.statistics.total_won_revenue.current),
                                    this.report.statistics.ventas_count.current
                                ],
                                ...
                                x: {
                                    ...
                                    ticks: {
                                        ...
                                        callback: (val) => {
                                            ...
                                            if (v >= 1000) {
                                                const t = v / 1000;
                                                if (Math.abs(t - 1) < 1e-9) return 'mil';
                                                const d = Number.isInteger(t) ? t.toString() : (Math.round(t * 10) / 10).toString();
                                                return d + ' mil';
                                            }
                                            return v;
                                        },
