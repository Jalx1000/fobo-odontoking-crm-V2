                ...
                <x-admin::table v-if="quotes.length">
                    ...
                    <x-admin::table.tbody>
                        <x-admin::table.tbody.tr v-for="quote in quotes" class="border-b">
                            ...
                            <x-admin::table.td class="!px-2">@{{ $admin.formatPrice(quote.sub_total) }}</x-admin::table.td>

                            <x-admin::table.td class="!px-2">@{{ $admin.formatPrice(quote.discount_amount) }}</x-admin::table.td>

                            <x-admin::table.td class="!px-2">@{{ $admin.formatPrice(quote.tax_amount) }}</x-admin::table.td>

                            <x-admin::table.td class="!px-2">@{{ $admin.formatPrice(quote.adjustment_amount) }}</x-admin::table.td>

                            <x-admin::table.td class="!px-2">@{{ $admin.formatPrice(quote.grand_total) }}</x-admin::table.td>
