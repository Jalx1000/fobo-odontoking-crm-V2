...
@pushOnce('scripts')
    ...
    >
        <div v-if="products.length" class="flex flex-1 flex-col gap-4 p-3">
        ...
        <div v-else class="flex flex-1 flex-col">
            <div class="h-full grid flex-1 content-center justify-center justify-items-center gap-3.5 py-12">
                <img
