...
export default {
    install: (app) => {
        ...
        /**
         * Custom Email Validation Rule (RFC Compliant)
         * Overrides the default email rule to accept a wider range of valid email formats.
         */
        defineRule("email", (value) => {
            ...
            // W3C HTML5 Email Regex (RFC 5322 compliant mostly)
